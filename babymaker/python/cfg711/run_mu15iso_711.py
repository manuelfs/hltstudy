# /users/jaehyeok/HLTRun2/RA4/V11 (CMSSW_7_1_6)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/jaehyeok/HLTRun2/RA4/V11')
)
...
#process.HLT_IsoMu15_IterTrk02_PFHT0_PFMET0_BTagCSV0_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sMu3 + process.hltPreIsoMu15IterTrk02PFHT0PFMET0BTagCSV0 + process.hltL1fL1sMu3L1Filtered0 + process.HLTL2muonrecoSequence + process.hltL2fL1sMu3L1f0L2Filtered0Q + process.HLTL3muonrecoSequence + process.hltL3fL1sMu3L1f0L2f0QL3Filtered15Q + process.HLTL3muoncaloisorecoSequenceNoBools + process.HLTTrackReconstructionForIsoL3MuonIter02 + process.hltL3crIsoL1sMu3L1f0L2f0QL3f15QL3crIsoRhoFiltered0p15IterTrk02 + process.HLTAK4PFJetsSequence + process.hltPFMETProducer + process.hltPFHT + process.hltPreBTagCSV07 + process.HLTAK4CaloJetsSequence + process.HLTFastPrimaryVertexSequence + process.hltFastPVPixelVertexSelector + process.HLTBtagCSVSequenceL3 + process.HLTEndSequence )
process.HLT_IsoMu15_IterTrk02_PFHT0_PFMET0_BTagCSV0_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sMu3 + process.hltPreIsoMu15IterTrk02PFHT0PFMET0BTagCSV0 + process.hltL1fL1sMu3L1Filtered0 + process.HLTL2muonrecoSequence + process.hltL2fL1sMu3L1f0L2Filtered0Q + process.HLTL3muonrecoSequence + process.hltL3fL1sMu3L1f0L2f0QL3Filtered15Q + process.HLTL3muoncaloisorecoSequenceNoBools + process.HLTTrackReconstructionForIsoL3MuonIter02 + process.hltL3crIsoL1sMu3L1f0L2f0QL3f15QL3crIsoRhoFiltered0p15IterTrk02 + process.HLTAK4PFJetsSequence + process.hltPFMETProducer + process.hltPFHT + process.antiktGenJets + process.HLTEndSequence  + process.babymakermu )
...
process.out = cms.OutputModule(
        "PoolOutputModule",
        fileName     = cms.untracked.string('ntuple_hlt_mu15iso.root'), ##
#        fileName     = cms.untracked.string('edm_hlt_muiso15.root'),
