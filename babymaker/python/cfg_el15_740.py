...
process.hltL3MuonCombRelIsolationVVVL = cms.EDProducer( "L3MuonCombinedRelativeIsolationProducer",
    ...
    CutsPSet = cms.PSet( 
      ...
      Thresholds = cms.vdouble( 99999.0 ),
...
process.out = cms.OutputModule(
        'PoolOutputModule',
        fileName     = cms.untracked.string('ntuple_hlt_el15_740.root'), ##
...
process.HLT_Ele15_IsoVVVL_BTagtop8CSV_PFHT_PFMET_v1 = cms.Path( process.SeqHLT_Ele15_IsoVVVL_BTagtop8CSV_PFHT_PFMET_v1 + process.IsoElectronProducer + process.babymaker )
