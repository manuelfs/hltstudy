# /users/manuelf/ForBabies/V8 (CMSSW_7_2_0_pre8)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/manuelf/ForBabies/V8')
)
...
process.out = cms.OutputModule(
        'PoolOutputModule',
        fileName     = cms.untracked.string('ntuple_hlt_el.root'), ##
