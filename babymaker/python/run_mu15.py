# /users/jaehyeok/HLTRun2/RA4/V12 (CMSSW_7_1_6)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/jaehyeok/HLTRun2/RA4/V12')
)
...
process.hltPreEle15WP80GsfPFHT200PFMET0 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPFHT300 = cms.EDFilter( "HLTHtMhtFilter",
    saveTags = cms.bool( True ),
    mhtLabels = cms.VInputTag( 'hltPFHT' ),
    meffSlope = cms.vdouble( 1.0 ),
    minMeff = cms.vdouble( 0.0 ),
...
process.hltPFHT200 = cms.EDFilter( "HLTHtMhtFilter",
    saveTags = cms.bool( True ),
    mhtLabels = cms.VInputTag( 'hltPFHT' ),
    meffSlope = cms.vdouble( 1.0 ),
    minMeff = cms.vdouble( 0.0 ),
...
process.hltPFMET0Filter = cms.EDFilter( "HLTMhtFilter",
    saveTags = cms.bool( True ),
    mhtLabels = cms.VInputTag( 'hltPFMETProducer' ),
    minMht = cms.vdouble( 0.0 )
)
process.hltL3fL1sMu16L1f0L2f16QL3Filtered27Q = cms.EDFilter( "HLTMuonL3PreFilter",
    MaxNormalizedChi2 = cms.double( 20.0 ),
    saveTags = cms.bool( True ),
    PreviousCandTag = cms.InputTag( "hltL2fL1sMu16L1f0L2Filtered16Q" ),
    MinNmuonHits = cms.int32( 0 ),
...
process.hltL2fL1sMu16L1f0L2Filtered0Q = cms.EDFilter( "HLTMuonL2PreFilter",
    saveTags = cms.bool( True ),
    MaxDr = cms.double( 9999.0 ),
    CutOnChambers = cms.bool( False ),
...
process.hltL3fL1sMu16L1f0L2f16QL3Filtered15Q = cms.EDFilter( "HLTMuonL3PreFilter",
    MaxNormalizedChi2 = cms.double( 20.0 ),
    saveTags = cms.bool( True ),
    PreviousCandTag = cms.InputTag( "hltL2fL1sMu16L1f0L2Filtered0Q" ),
    MinNmuonHits = cms.int32( 0 ),
    MinN = cms.int32( 1 ),
    MinTrackPt = cms.double( 0.0 ),
    MaxEta = cms.double( 2.5 ),
...
process.hltL3fL1sMu16L1f0L2f0QL3Filtered15Q = cms.EDFilter( "HLTMuonL3PreFilter",
    MaxNormalizedChi2 = cms.double( 20.0 ),
    saveTags = cms.bool( True ),
    PreviousCandTag = cms.InputTag( "hltL2fL1sMu3L1f0L2Filtered0Q" ),
    MinNmuonHits = cms.int32( 0 ),
    MinN = cms.int32( 1 ),
    MinTrackPt = cms.double( 0.0 ),
    MaxEta = cms.double( 2.5 ),
...
process.hltPreIsoMu15IterTrk02PFHT0PFMET0BTagCSV0 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
process.hltL3crIsoL1sMu16L1f0L2f16QL3f24QL3crIsoRhoFiltered0p15IterTrk02 = cms.EDFilter( "HLTMuonIsoFilter",
    saveTags = cms.bool( True ),
    PreviousCandTag = cms.InputTag( "hltL3fL1sMu16L1f0L2f0QL3Filtered24Q" ),
    MinN = cms.int32( 1 ),
    IsolatorPSet = cms.PSet(  ),
    CandTag = cms.InputTag( "hltL3MuonCandidates" ),
    DepTag = cms.VInputTag( 'hltL3MuonCombRelIsolationsIterTrkRegIter02' )
)
process.hltL1sMu3 = cms.EDFilter( "HLTLevel1GTSeed",
    L1SeedsLogicalExpression = cms.string( "L1_SingleMu3" ),
    saveTags = cms.bool( True ),
    L1MuonCollectionTag = cms.InputTag( "hltL1extraParticles" ),
    L1UseL1TriggerObjectMaps = cms.bool( True ),
...
process.hltL2fL1sMu3L1f0L2Filtered0Q = cms.EDFilter( "HLTMuonL2PreFilter",
    saveTags = cms.bool( True ),
    MaxDr = cms.double( 9999.0 ),
    CutOnChambers = cms.bool( False ),
    PreviousCandTag = cms.InputTag( "hltL1fL1sMu3L1Filtered0" ),
...
process.hltL3fL1sMu3L1f0L2f0QL3Filtered15Q = cms.EDFilter( "HLTMuonL3PreFilter",
    MaxNormalizedChi2 = cms.double( 20.0 ),
    saveTags = cms.bool( True ),
    PreviousCandTag = cms.InputTag( "hltL2fL1sMu3L1f0L2Filtered0Q" ),
    MinNmuonHits = cms.int32( 0 ),
...
process.hltL3crIsoL1sMu3L1f0L2f0QL3f15QL3crIsoRhoFiltered0p15IterTrk02 = cms.EDFilter( "HLTMuonIsoFilter",
    saveTags = cms.bool( True ),
    PreviousCandTag = cms.InputTag( "hltL3fL1sMu3L1f0L2f0QL3Filtered15Q" ),
    MinN = cms.int32( 1 ),
    IsolatorPSet = cms.PSet(  ),
    CandTag = cms.InputTag( "hltL3MuonCandidates" ),
    DepTag = cms.VInputTag( 'hltL3MuonCombRelIsolationsIterTrkRegIter02' )
...
if 'hltTrigReport' in process.__dict__:
    process.hltTrigReport.HLTriggerResults                    = cms.InputTag( 'TriggerResults', '', 'reHLT' )

if 'hltPreExpressCosmicsOutputSmart' in process.__dict__:
    process.hltPreExpressCosmicsOutputSmart.hltResults = cms.InputTag( 'TriggerResults', '', 'reHLT' )

if 'hltPreExpressOutputSmart' in process.__dict__:
    process.hltPreExpressOutputSmart.hltResults        = cms.InputTag( 'TriggerResults', '', 'reHLT' )

if 'hltPreDQMForHIOutputSmart' in process.__dict__:
    process.hltPreDQMForHIOutputSmart.hltResults       = cms.InputTag( 'TriggerResults', '', 'reHLT' )

if 'hltPreDQMForPPOutputSmart' in process.__dict__:
    process.hltPreDQMForPPOutputSmart.hltResults       = cms.InputTag( 'TriggerResults', '', 'reHLT' )

if 'hltPreHLTDQMResultsOutputSmart' in process.__dict__:
    process.hltPreHLTDQMResultsOutputSmart.hltResults  = cms.InputTag( 'TriggerResults', '', 'reHLT' )

if 'hltPreHLTDQMOutputSmart' in process.__dict__:
    process.hltPreHLTDQMOutputSmart.hltResults         = cms.InputTag( 'TriggerResults', '', 'reHLT' )

if 'hltPreHLTMONOutputSmart' in process.__dict__:
    process.hltPreHLTMONOutputSmart.hltResults         = cms.InputTag( 'TriggerResults', '', 'reHLT' )

if 'hltDQMHLTScalers' in process.__dict__:
    process.hltDQMHLTScalers.triggerResults                   = cms.InputTag( 'TriggerResults', '', 'reHLT' )
    process.hltDQMHLTScalers.processname                      = 'reHLT'

if 'hltDQML1SeedLogicScalers' in process.__dict__:
    process.hltDQML1SeedLogicScalers.processname              = 'reHLT'
...
process.out = cms.OutputModule(
        'PoolOutputModule',
        fileName     = cms.untracked.string('ntuple_hlt_mu15.root'), ##
...
process.SeqHLT_Mu40_v1 = cms.Sequence( process.HLTBeginSequence + process.hltL1sMu16 + process.hltPreMu40 + process.hltL1fL1sMu16L1Filtered0 + process.HLTL2muonrecoSequence + process.hltL2fL1sMu16L1f0L2Filtered16Q + process.HLTL3muonrecoSequence + process.hltL3fL1sMu16L1f0L2f16QL3Filtered40Q + process.antiktGenJets + process.HLTEndSequence )
process.SeqHLT_Ele27_WP80_Gsf_v1 = cms.Sequence( process.HLTBeginSequence + process.hltL1sL1SingleEG20ORL1SingleEG22 + process.hltPreEle27WP80Gsf + process.HLTEle27WP80GsfSequence + process.antiktGenJets + process.HLTEndSequence )
process.SeqHLT_PFHT650_v1 = cms.Sequence( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPreEle15WP80GsfPFHT200PFMET0 + process.HLTAK4CaloJetsSequence + process.hltHtMht + process.hltHt550 + process.HLTAK4PFJetsSequence + process.hltPFHT + process.hltPFHT650 + process.antiktGenJets + process.HLTEndSequence )
process.SeqHLT_Ele27_WP80_Gsf_PFHT300_PFMET40_v1 = cms.Sequence( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPreEle15WP80GsfPFHT200PFMET0 + process.HLTAK4CaloJetsSequence + process.hltHtMht + process.hltHt200 + process.HLTAK4PFJetsSequence + process.hltPFHT + process.hltPFHT300 + process.hltPFMETProducer + process.hltPFMET40Filter + process.hltL1sL1SingleEG20ORL1SingleEG22 + process.hltPreEle27WP80Gsf + process.HLTEle27WP80GsfSequence + process.antiktGenJets + process.HLTEndSequence )
process.SeqHLT_Ele15_WP80_Gsf_PFHT300_PFMET40_v1 = cms.Sequence( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPreEle15WP80GsfPFHT200PFMET0 + process.HLTAK4CaloJetsSequence + process.hltHtMht + process.hltHt200 + process.HLTAK4PFJetsSequence + process.hltPFHT + process.hltPFHT300 + process.hltPFMETProducer + process.hltPFMET40Filter + process.hltL1sL1SingleEG20ORL1SingleEG22 + process.hltPreEle27WP80Gsf + process.HLTEle27WP80GsfSequence + process.antiktGenJets + process.HLTEndSequence )
process.SeqHLT_Ele15_WP80_Gsf_PFHT200_PFMET0_v1 = cms.Sequence( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPreEle15WP80GsfPFHT200PFMET0 + process.HLTAK4CaloJetsSequence + process.hltHtMht + process.hltHt100 + process.HLTAK4PFJetsSequence + process.hltPFHT + process.hltPFHT200 + process.hltPFMETProducer + process.hltPFMET0Filter + process.hltL1sL1SingleEG20ORL1SingleEG22 + process.hltPreEle27WP80Gsf + process.HLTEle27WP80GsfSequence + process.antiktGenJets + process.HLTEndSequence )
process.SeqCopy_of_HLT_Ele15_WP80_Gsf_PFHT200_PFMET0_v1 = cms.Sequence( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPreEle15WP80GsfPFHT200PFMET0 + process.HLTAK4CaloJetsSequence + process.HLTAK4PFJetsSequence + process.hltPFHT + process.hltPFMETProducer + process.hltL1sL1SingleEG20ORL1SingleEG22 + process.hltPreEle27WP80Gsf + process.HLTEle27WP80GsfSequence + process.antiktGenJets + process.HLTEndSequence )
process.SeqHLT_Mu27_PFHT300_PFMET40_v1 = cms.Sequence( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPreEle15WP80GsfPFHT200PFMET0 + process.HLTAK4CaloJetsSequence + process.hltHtMht + process.hltHt200 + process.HLTAK4PFJetsSequence + process.hltPFHT + process.hltPFHT300 + process.hltPFMETProducer + process.hltPFMET40Filter + process.hltL1sMu16 + process.hltPreMu40 + process.hltL1fL1sMu16L1Filtered0 + process.HLTL2muonrecoSequence + process.hltL2fL1sMu16L1f0L2Filtered16Q + process.HLTL3muonrecoSequence + process.hltL3fL1sMu16L1f0L2f16QL3Filtered27Q + process.antiktGenJets + process.HLTEndSequence )
process.SeqHLT_Mu15_PFHT300_PFMET40_v1 = cms.Sequence( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPreEle15WP80GsfPFHT200PFMET0 + process.HLTAK4CaloJetsSequence + process.hltHtMht + process.hltHt200 + process.HLTAK4PFJetsSequence + process.hltPFHT + process.hltPFHT300 + process.hltPFMETProducer + process.hltPFMET40Filter + process.hltL1sMu16 + process.hltPreMu40 + process.hltL1fL1sMu16L1Filtered0 + process.HLTL2muonrecoSequence + process.hltL2fL1sMu16L1f0L2Filtered0Q + process.HLTL3muonrecoSequence + process.hltL3fL1sMu16L1f0L2f16QL3Filtered15Q + process.antiktGenJets + process.HLTEndSequence )
process.SeqHLT_Mu15_PFHT200_PFMET0_v1 = cms.Sequence( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPreEle15WP80GsfPFHT200PFMET0 + process.HLTAK4CaloJetsSequence + process.hltHtMht + process.hltHt100 + process.HLTAK4PFJetsSequence + process.hltPFHT + process.hltPFHT200 + process.hltPFMETProducer + process.hltPFMET0Filter + process.hltL1sMu16 + process.hltPreMu40 + process.hltL1fL1sMu16L1Filtered0 + process.HLTL2muonrecoSequence + process.hltL2fL1sMu16L1f0L2Filtered0Q + process.HLTL3muonrecoSequence + process.hltL3fL1sMu16L1f0L2f0QL3Filtered15Q + process.antiktGenJets + process.HLTEndSequence )
process.SeqCopy_of_HLT_Mu15_PFHT200_PFMET0_v1 = cms.Sequence( process.HLTBeginSequence + process.hltL1sL1HTT150OrHTT175 + process.hltPreEle15WP80GsfPFHT200PFMET0 + process.HLTAK4CaloJetsSequence + process.hltHtMht + process.hltHt100 + process.HLTAK4PFJetsSequence + process.hltPFHT + process.hltPFHT200 + process.hltPFMETProducer + process.hltPFMET0Filter + process.hltL1sMu16 + process.hltPreMu40 + process.hltL1fL1sMu16L1Filtered0 + process.HLTL2muonrecoSequence + process.hltL2fL1sMu16L1f0L2Filtered0Q + process.HLTL3muonrecoSequence + process.hltL3fL1sMu16L1f0L2f0QL3Filtered15Q + process.antiktGenJets + process.HLTEndSequence )
process.SeqHLT_Photon135_PFMET40_v1 = cms.Sequence( process.HLTBeginSequence + process.hltL1sL1SingleEG30 + process.hltPrePhoton135PFMET40 + process.HLTSinglePhoton135Sequence + process.hltPFMETProducer + process.HLTAK4PFJetsSequence + process.hltPFMET40Filter + process.antiktGenJets + process.HLTEndSequence )
process.SeqHLT_IsoMu24_IterTrk02_v1 = cms.Sequence( process.HLTBeginSequence + process.hltL1sMu16 + process.hltPreIsoMu15IterTrk02PFHT0PFMET0BTagCSV0 + process.hltL1fL1sMu16L1Filtered0 + process.HLTL2muonrecoSequence + process.hltL2fL1sMu16L1f0L2Filtered16Q + process.HLTL3muonrecoSequence + process.hltL3fL1sMu16L1f0L2f16QL3Filtered24Q + process.HLTL3muoncaloisorecoSequenceNoBools + process.HLTTrackReconstructionForIsoL3MuonIter02 + process.hltL3crIsoL1sMu16L1f0L2f16QL3f24QL3crIsoRhoFiltered0p15IterTrk02 + process.antiktGenJets + process.HLTEndSequence )
process.SeqHLT_IsoMu15_IterTrk02_v1 = cms.Sequence( process.HLTBeginSequence + process.hltL1sMu3 + process.hltPreIsoMu15IterTrk02PFHT0PFMET0BTagCSV0 + process.hltL1fL1sMu3L1Filtered0 + process.HLTL2muonrecoSequence + process.hltL2fL1sMu3L1f0L2Filtered0Q + process.HLTL3muonrecoSequence + process.hltL3fL1sMu3L1f0L2f0QL3Filtered15Q + process.HLTL3muoncaloisorecoSequenceNoBools + process.HLTTrackReconstructionForIsoL3MuonIter02 + process.hltL3crIsoL1sMu3L1f0L2f0QL3f15QL3crIsoRhoFiltered0p15IterTrk02 + process.antiktGenJets + process.HLTEndSequence )
process.SeqHLT_IsoMu15_IterTrk02_PFHT0_PFMET0_v1 = cms.Sequence( process.HLTBeginSequence + process.hltL1sMu3 + process.hltPreIsoMu15IterTrk02PFHT0PFMET0BTagCSV0 + process.hltL1fL1sMu3L1Filtered0 + process.HLTL2muonrecoSequence + process.hltL2fL1sMu3L1f0L2Filtered0Q + process.HLTL3muonrecoSequence + process.hltL3fL1sMu3L1f0L2f0QL3Filtered15Q + process.HLTL3muoncaloisorecoSequenceNoBools + process.HLTTrackReconstructionForIsoL3MuonIter02 + process.hltL3crIsoL1sMu3L1f0L2f0QL3f15QL3crIsoRhoFiltered0p15IterTrk02 + process.HLTAK4PFJetsSequence + process.hltPFMETProducer + process.hltPFHT + process.antiktGenJets + process.HLTEndSequence )
process.SeqHLT_IsoMu15_IterTrk02_PFHT0_PFMET0_BTagCSV0_v1 = cms.Sequence( process.HLTBeginSequence + process.hltL1sMu3 + process.hltPreIsoMu15IterTrk02PFHT0PFMET0BTagCSV0 + process.hltL1fL1sMu3L1Filtered0 + process.HLTL2muonrecoSequence + process.hltL2fL1sMu3L1f0L2Filtered0Q + process.HLTL3muonrecoSequence + process.hltL3fL1sMu3L1f0L2f0QL3Filtered15Q + process.HLTL3muoncaloisorecoSequenceNoBools + process.HLTTrackReconstructionForIsoL3MuonIter02 + process.hltL3crIsoL1sMu3L1f0L2f0QL3f15QL3crIsoRhoFiltered0p15IterTrk02 + process.HLTAK4PFJetsSequence + process.hltPFMETProducer + process.hltPFHT + process.hltPreBTagCSV07 + process.HLTAK4CaloJetsSequence + process.HLTFastPrimaryVertexSequence + process.hltFastPVPixelVertexSelector + process.HLTBtagCSVSequenceL3 + process.antiktGenJets + process.HLTEndSequence )
process.SeqHLT_BTagCSV07_v1 = cms.Sequence( process.HLTBeginSequence + process.hltPreBTagCSV07 + process.HLTAK4CaloJetsSequence + process.HLTFastPrimaryVertexSequence + process.hltFastPVPixelVertexSelector + process.HLTBtagCSVSequenceL3 + process.hltBLifetimeL3FilterCSV + process.antiktGenJets + process.HLTEndSequence )

process.HLT_Mu40_v1 = cms.Path( process.SeqHLT_Mu40_v1 + process.reco + process.babymaker)
process.HLT_Ele27_WP80_Gsf_v1 = cms.Path( process.SeqHLT_Ele27_WP80_Gsf_v1 + process.reco + process.babymaker)
process.HLT_PFHT650_v1 = cms.Path( process.SeqHLT_PFHT650_v1 + process.reco + process.babymaker)
process.HLT_Ele27_WP80_Gsf_PFHT300_PFMET40_v1 = cms.Path( process.SeqHLT_Ele27_WP80_Gsf_PFHT300_PFMET40_v1 + process.reco + process.babymaker)
process.HLT_Ele15_WP80_Gsf_PFHT300_PFMET40_v1 = cms.Path( process.SeqHLT_Ele15_WP80_Gsf_PFHT300_PFMET40_v1 + process.reco + process.babymaker)
process.HLT_Ele15_WP80_Gsf_PFHT200_PFMET0_v1 = cms.Path( process.SeqHLT_Ele15_WP80_Gsf_PFHT200_PFMET0_v1 + process.reco + process.babymaker)
process.Copy_of_HLT_Ele15_WP80_Gsf_PFHT200_PFMET0_v1 = cms.Path( process.SeqCopy_of_HLT_Ele15_WP80_Gsf_PFHT200_PFMET0_v1 + process.reco + process.babymaker)
process.HLT_Mu27_PFHT300_PFMET40_v1 = cms.Path( process.SeqHLT_Mu27_PFHT300_PFMET40_v1 + process.reco + process.babymaker)
process.HLT_Mu15_PFHT300_PFMET40_v1 = cms.Path( process.SeqHLT_Mu15_PFHT300_PFMET40_v1 + process.reco + process.babymaker)
process.HLT_Mu15_PFHT200_PFMET0_v1 = cms.Path( process.SeqHLT_Mu15_PFHT200_PFMET0_v1 + process.reco + process.babymaker)
process.Copy_of_HLT_Mu15_PFHT200_PFMET0_v1 = cms.Path( process.SeqCopy_of_HLT_Mu15_PFHT200_PFMET0_v1 + process.reco + process.babymaker)
process.HLT_Photon135_PFMET40_v1 = cms.Path( process.SeqHLT_Photon135_PFMET40_v1 + process.reco + process.babymaker)
process.HLT_IsoMu24_IterTrk02_v1 = cms.Path( process.SeqHLT_IsoMu24_IterTrk02_v1 + process.reco + process.babymaker)
process.HLT_IsoMu15_IterTrk02_v1 = cms.Path( process.SeqHLT_IsoMu15_IterTrk02_v1 + process.reco + process.babymaker)
process.HLT_IsoMu15_IterTrk02_PFHT0_PFMET0_v1 = cms.Path( process.SeqHLT_IsoMu15_IterTrk02_PFHT0_PFMET0_v1 + process.reco + process.babymaker)
process.HLT_IsoMu15_IterTrk02_PFHT0_PFMET0_BTagCSV0_v1 = cms.Path( process.SeqHLT_IsoMu15_IterTrk02_PFHT0_PFMET0_BTagCSV0_v1 + process.reco + process.babymaker)
process.HLT_BTagCSV07_v1 = cms.Path( process.SeqHLT_BTagCSV07_v1 + process.reco + process.babymaker)

process.schedule = cms.Schedule( process.HLT_IsoMu15_IterTrk02_PFHT0_PFMET0_v1, process.outpath ) ##
