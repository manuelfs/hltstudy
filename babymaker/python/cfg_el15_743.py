# /users/manuelf/CMSSW_7_4_X/ForBabies743/V4 (CMSSW_7_4_3)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/manuelf/CMSSW_7_4_X/ForBabies743/V4')
)
...
process.hltPreEle15IsoVVVLHTMETBtag = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
process.out = cms.OutputModule(
        'PoolOutputModule',
        fileName     = cms.untracked.string('ntuple_hlt_el15_743.root'), ##
...
process.SeqHLT_Ele15_IsoVVVL_HT_MET_Btag_v2 = cms.Sequence( process.HLTBeginSequence + process.hltL1sL1HTT150ORHTT175 + process.hltPreEle15IsoVVVLHTMETBtag + cms.ignore(process.hltL1sL1SingleEG5Open) + process.HLTAK4CaloJetsSequence + process.hltHtMht + process.hltHT200 + process.hltSusyPreBtagJetFilter + process.HLTFastPrimaryVertexSequence + process.hltFastPVPixelVertexSelector + process.HLTBtagCSVSequenceL3 + process.HLTEle15VVVLGsfSequence + process.HLTAK4PFJetsSequence + process.hltPFHT + process.hltPFMETProducer + process.antiktGenJets + process.HLTEndSequence )
...
process.HLT_Ele15_IsoVVVL_HT_MET_Btag_v2 = cms.Path( process.SeqHLT_Ele15_IsoVVVL_HT_MET_Btag_v2 + process.IsoElectronProducer + process.babymaker )
