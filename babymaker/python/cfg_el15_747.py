...
process.hltPreMu15IsoVVVLBTagPFHTPFMET = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
process.hltL1fL1sSingleMuOpenCandidateL1Filtered0 = cms.EDFilter( "HLTMuonL1Filter",
...
process.hltPreEle15IsoVVVLBTagPFHTPFMET = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
# process.HLTSchedule = cms.Schedule( *(process.HLT_Mu15_IsoVVVL_BTag_PFHT_PFMET_v2, process.HLT_Ele15_IsoVVVL_BTag_PFHT_PFMET_v2 ))
...
process.source = cms.Source( "PoolSource",
    fileNames = cms.untracked.vstring(
        'file:/nfs-7/userdata/manuelf/data/SMS-T1tttt_2J_mGl-1500_mLSP-100_Tune4C_13TeV-madgraph-tauola__GEN-SIM-RAW__PU20bx25_POSTLS170_V5-v2.root',
    ),
...
process.out = cms.OutputModule(
        'PoolOutputModule',
        fileName     = cms.untracked.string('ntuple_hlt_el15_747noiso.root'), ##
...
process.SeqHLT_Mu15_IsoVVVL_BTag_PFHT_PFMET_v2 = cms.Sequence( process.HLTBeginSequence + process.hltL1sL1HTT150ORHTT175 + process.hltPreMu15IsoVVVLBTagPFHTPFMET + cms.ignore(process.hltL1sL1SingleMuOpenCandidate) + process.HLTAK4CaloJetsSequence + process.hltHtMht + process.hltHT200 + process.hltSusyPreBtagJetFilter + process.HLTFastPrimaryVertexSequence + process.hltFastPVPixelVertexSelector + process.HLTBtagCSVSequenceL3 + process.hltL1fL1sSingleMuOpenCandidateL1Filtered0 + process.HLTL2muonrecoSequence + process.hltL2fL1sSingleMuOpenCandidateL1f0L2Filtered0Q + process.HLTL3muonrecoSequence + process.hltL3fL1sSingleMuOpenCandidateL1f0L2f3QL3Filtered15Q + process.HLTMuVVVLCombinedIsolationR02Sequence + process.hltL3MuVVVLIsoFIlter + process.HLTAK4PFJetsSequence + process.hltPFHT + process.hltPFMETProducer + process.antiktGenJets + process.HLTEndSequence )
process.SeqHLT_Ele15_IsoVVVL_BTag_PFHT_PFMET_v2 = cms.Sequence( process.HLTBeginSequence + process.hltL1sL1HTT150ORHTT175 + process.hltPreEle15IsoVVVLBTagPFHTPFMET + cms.ignore(process.hltL1sL1SingleEG5Open) + process.HLTAK4CaloJetsSequence + process.hltHtMht + process.hltHT200 + process.hltSusyPreBtagJetFilter + process.HLTFastPrimaryVertexSequence + process.hltFastPVPixelVertexSelector + process.HLTBtagCSVSequenceL3 + process.HLTEle15VVVLGsfSequence + process.HLTAK4PFJetsSequence + process.hltPFHT + process.hltPFMETProducer + process.antiktGenJets + process.HLTEndSequence )

process.HLT_Ele15_IsoVVVL_BTag_PFHT_PFMET_v2 = cms.Path( process.SeqHLT_Ele15_IsoVVVL_BTag_PFHT_PFMET_v2 + process.IsoElectronProducer + process.babymaker )
